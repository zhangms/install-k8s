...
function createKubeConfig() {
    ...
    kubectl config set-cluster kubernetes-demo --server=https://${kube_master_ip}:${kube_master_port} --insecure-skip-tls-verify=true --kubeconfig=/etc/kubernetes/kubeconfig
